          ...
          {documents.length === 0 ? (
            ...
            documents.map((doc) => (
              <button
                ...
                className="w-full text-left p-3 rounded-lg mb-2 transition-all backdrop-blur-xl hover:bg-gray-100 dark:hover:bg-[#090e1c] border border-transparent hover:border-blue-300 dark:hover:border-blue-500/30"
              >
