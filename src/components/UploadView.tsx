                    ...
                    >
                      ...
                      <div className="mb-8">
                        ...
                        <div className="flex justify-center gap-4">
                          ...
                          >
                            <div className={cn("w-10 h-10 rounded-full flex items-center justify-center", documentType === 'scanned' ? "bg-gradient-to-br from-blue-500 to-indigo-600" : "bg-gray-200 dark:bg-gray-700")}>
                              <Scan className={cn("w-5 h-5", documentType === 'scanned' ? "text-white" : "text-gray-600 dark:text-white")} />
                            </div>
                            <div className="text-left">
                              <p className={cn("font-semibold", documentType === 'scanned' ? 'text-blue-600 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300')}>Scanned</p>
                          ...
                          <motion.div
                            ...
                            whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                          >
                            <div className={cn("w-10 h-10 rounded-full flex items-center justify-center", documentType === 'electronic' ? "bg-gradient-to-br from-green-500 to-emerald-600" : "bg-gray-200 dark:bg-gray-700")}>
                              <FileDigit className={cn("w-5 h-5", documentType === 'electronic' ? "text-white" : "text-gray-600 dark:text-white")} />
                            </div>
                            <div className="text-left">
                              <p className={cn("font-semibold", documentType === 'electronic' ? 'text-green-600 dark:text-green-300' : 'text-gray-700 dark:text-gray-300')}>Electronic</p>
                      ...
                      <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="space-y-5">
                          ...
                          <p className="text-gray-600 dark:text-gray-300 max-w-md">Drag and drop your file or click to browse.</p>
                          <Button onClick={() => fileInputRef.current?.click()} className="mt-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 px-6 py-3 font-medium text-white">
                      ...
                      <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-700/50 rounded-xl p-4 w-full flex items-center gap-4">
                          ...
                          <div className="flex-1 min-w-0 text-left">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">{(selectedFile.size / 1024 / 1024).toFixed(2)} MB • Ready</p>
                          </div>
                          <Button onClick={() => setSelectedFile(null)} size="icon" variant="ghost" className="text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-700/50">
                            <X className="w-5 h-5" />
                          </Button>
                        </div>
                        <div className="flex gap-4 w-full mt-2">
                          <Button onClick={() => setSelectedFile(null)} variant="outline" className="flex-1 bg-transparent border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700/50 text-gray-700 dark:text-gray-300">
                            Change File
                          </Button>
